...
## 2. Speed up onset median (numpy-only) — DONE

Done 2026-08-01: rolling median via `sliding_window_view` + `np.median` (every 8 frames); behavior unchanged; ~10× faster on synthetic flux.
```
